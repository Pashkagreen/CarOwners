...
import { Background, CustomHeader, VehicleCard } from '@components/index';
import VehiclesCarousel from '@modals/vehicles-carousel';
...
import VehicleListLoader from './vehicle-list-loader';
